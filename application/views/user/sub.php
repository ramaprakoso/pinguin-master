   ...
   <div class="left-modul forum-modul">
        ...
        <tbody>
          ...
          <tr> <!-- Baris / row, kalo td nya kolom -->
            <td><a href="<?php echo site_url();?>forum/get_thread/<?php echo $row->id_kate;?>" class="kategori"><?php echo $row->subforum;?></a><br>
            <p class="deks"></p></td>
            <td><a href="<?php echo base_url()?>forum/get_thread/<?php echo $row->id_thread;?>"><?php echo $row->thread_title;?></a></td>
            <td><a href="<?php echo base_url()?>forum/get_thread/<?php echo $row->username;?>"><?php echo $row->username?></a></td>
            <td>Oleh <a href="#user" class="user"></a><br><span></span>
            </td>
          </tr>
          <?php
          }
